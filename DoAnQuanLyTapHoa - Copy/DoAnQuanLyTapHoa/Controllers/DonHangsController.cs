...
//        {
//            var donHangs = db.DonHangs.Include(d => d.MaUser);
...
//        {
//            var dailyTotal = db.DonHangs.GroupBy(t => DbFunctions.TruncateTime(t.NgayDH)).Select(g => new /*DonHang*/ { NgayMua = g.Key, TongTien = g.Sum(t => t.TongTien) }).ToList();
//            var dailyRevenueList = dailyTotal.Select(d => new DonHang { NgayDH = d.NgayMua, Trigia = d.TongTien }).ToList();
...
//                        Value = s.Trigia.Value // Số tiền doanh số
//                    })
//                    .ToList();
//                return data;
//            }
